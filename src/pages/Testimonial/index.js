...
const Testimonial = () => {
  ...
  const { data, refetch: getData, isLoading } = useQuery(['testimonials', search, page], () => api.testimonial({
    params: {
      page: page,
      search: search,
    }
  ...
  const deleteAction = async () => {
    const brands = await del(`/testimonials/${deleteId}`);
    setShowDelete(false)
    getData();
  }
  ...
  const TestimonialColumns = toggleModal => [
    {
      dataField: "id",
      text: "#",
      sort: true,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Home" breadcrumbItem="Testimonial" />
          <Row>
            <Col xs="12">
              <Card>
                <CardBody>
